        ...
        <Grid container spacing={4}>
                ...
                <FooterSection
                    ...
                    body1={
                        <>
                            ...
                            >
                                Download Resume&nbsp; {socialMediaIcons['Resume']}
                            </Button>
                        </>
                    }
                    body2={
                        <Button href="/portfolio#About" sx={{ color: 'secondary.main' }}>
                            Go to About Section
                        </Button>
                    }
                />
            ...
            <Grid size={{ xs: 12, sm: 4 }}>
                <FooterSection
                    ...
                    body1={
                        <>
                            Email:{' '}
                            <a href="mailto:tkhalim14@gmail.com" style={{ color: colors[10] }}>
                                tkhalim14@gmail.com
                            </a>{' '}
                        </>
                    }
            ...
            <Grid size={{ xs: 12, sm: 4 }}>
                <FooterSection
                    ...
                    body1={
                        <div>
                            {Object.entries(socialMediaIcons).map(([element, elementIcon]) => (
                                <a
                                    key={element}
                                    aria-label={element}
                                    className="nav-link"
                                    href={socialMediaLinks[element]}
                                    style={{ padding: 3, color: colors[2] }}
                                >
                                    {elementIcon}
                                </a>
                            ))}
