...
import { Grid, Card, Tooltip, CardContent, Typography, Box } from '@mui/material';
...
const ProfileCard = () => (
    <Card sx={{ borderTopLeftRadius: 0, borderTopRightRadius: 0 }} alt="ProfileCard">
        <CardContent>
            ...
            <div style={{ fontSize: 14, letterSpacing: 0.5 }} color="text.secondary">
                ...
                >
                    ...
                    >
                        ...
                        >
                            <a href="https://www.iitdh.ac.in" style={{ color: colors[3] }}>
                                IIT Dharwad
                            </a>
            ...
            <Typography>
                I am characterized by my passion and dedication towards coding, consistently
                striving to enhance my skills and delve into novel realms. My commitment to
                self-improvement and exploration remains steadfast.
                <br />
                <br />
            </Typography>
            ...
            <Grid container spacing={5}>
                <Grid>
                    Thanks for visiting my portfolio. Explore my projects and experiences, and
                    let&apos;s connect!
                </Grid>
            </Grid>
        </CardContent>
